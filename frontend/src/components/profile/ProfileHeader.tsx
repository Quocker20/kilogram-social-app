    ...
    <header className="flex flex-col md:flex-row items-center md:items-start space-y-4 md:space-y-0 md:space-x-12 mb-12 px-4">
      ...
      <div className="flex-1 flex flex-col space-y-4">
        ...
        <div className="flex space-x-8 text-sm md:text-base">
          ...
          <button className="hover:opacity-70"><span className="font-semibold">{profile.numOfFollowers || 0}</span> followers</button>
          <button className="hover:opacity-70"><span className="font-semibold">{profile.numOfFollowing || 0}</span> following</button>
        </div>
